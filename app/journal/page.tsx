...
const ENTRIES: {
...
}[] = [
  {
    date: "12.06.26",
    kind: "Atelier",
    title: "Eleven days for one coat",
    excerpt:
      "The Monolith takes eleven days, and nine of them are spent on a seam nobody will ever see from the front.",
    tone: "stone",
  },
  {
    date: "28.05.26",
    kind: "Material",
    title: "Why the brass is left unlacquered",
    excerpt:
      "Lacquer keeps brass looking new. We would rather it looked like yours.",
    tone: "gold",
  },
  {
    date: "04.05.26",
