 ...
 *
 * Every frame fills the screen edge to edge, on every device — no
 * letterbox, no side borders. A portrait photograph on a landscape
 * display therefore loses better than half its height, so `focus` is not
 * decoration: it names the band of the frame that must survive the crop.
 * Get it wrong and a full-length dress becomes a photograph of a waist.
 */
...
export const SLIDES: Slide[] = [
  { slug: "kal03419", kind: "wear", label: "Backstage, Lagos", focus: "50% 46%" },
  { slug: "img-5667", kind: "jewelry", label: "The Crimson Drop", focus: "50% 54%" },
  { slug: "1767551647754", kind: "wear", label: "Tweed and Tulle", focus: "50% 56%" },
  { slug: "1767531220533", kind: "jewelry", label: "Stacked at the Wrist", focus: "50% 46%" },
  { slug: "img-5714", kind: "wear", label: "The Rosette Lattice", focus: "50% 56%" },
  { slug: "img-5610", kind: "jewelry", label: "Citrine and Moonstone", grade: "studio" },
  { slug: "1767531220079", kind: "beauty", label: "Pearl, Close", focus: "50% 30%" },
  { slug: "img-5733", kind: "wear", label: "The Turquoise Column", focus: "50% 52%" },
  { slug: "img-5587", kind: "jewelry", label: "Rutilated, Mixed", grade: "studio" },
  { slug: "img-5389", kind: "wear", label: "Black, in Afternoon Light", focus: "50% 44%" },
  { slug: "img-5660", kind: "jewelry", label: "Red Stone, Set in Gold", focus: "50% 52%" },
  { slug: "img-5708", kind: "wear", label: "The Ruffle Gown", focus: "50% 56%" },
  { slug: "img-5573", kind: "jewelry", label: "Citrine, Double Strand", grade: "studio" },
  { slug: "1767615547311", kind: "wear", label: "White Tweed, Off Shoulder", focus: "50% 40%" },
  { slug: "img-5895", kind: "jewelry", label: "Strawberry Quartz", grade: "studio" },
  { slug: "img-5734", kind: "wear", label: "The Sculpted Jacket", focus: "50% 48%" },
  { slug: "img-5596", kind: "jewelry", label: "Quartz on Driftwood", grade: "studio" },
  { slug: "1767372347865-2", kind: "wear", label: "Full Length, White Room", focus: "50% 54%" },
  { slug: "img-5366", kind: "jewelry", label: "Snow Quartz", focus: "50% 48%", grade: "studio" },
  { slug: "img-5713", kind: "wear", label: "On the Stand", focus: "50% 56%" },
  { slug: "img-5658", kind: "jewelry", label: "Rose Quartz, Silver Set", grade: "studio" },
  { slug: "1767531220127", kind: "wear", label: "Magenta and Tweed", focus: "50% 40%" },
  { slug: "img-5654", kind: "jewelry", label: "Citrine, Gold Fittings", grade: "studio" },
  { slug: "img-5387", kind: "wear", label: "The Green Silk", focus: "50% 40%" },
  { slug: "img-5466", kind: "jewelry", label: "Snow Quartz on Black", focus: "50% 48%", grade: "studio" },
];
